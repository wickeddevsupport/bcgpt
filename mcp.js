...
const ERROR_TAXONOMY = {
  ...
  MISSING_FIELDS: { category: "input", retryable: false },
  CONFIRM_REQUIRED: { category: "input", retryable: false, action: "confirm" },
  N8N_API_KEY_REQUIRED: { category: "auth", retryable: false },
  N8N_API_ERROR: { category: "api" },
  N8N_REQUEST_FAILED: { category: "network", retryable: true },
