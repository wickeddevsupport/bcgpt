...
export function getTools() {
  const tools = [
    ...
    tool("n8n_set_api_key", "Store an n8n API key for the current session/user.", {
      type: "object",
      properties: {
        api_key: { type: "string" }
      },
    ...
    tool("n8n_status", "Check whether an n8n API key is stored for the current session/user.", noProps()),
    tool("n8n_request", "Raw n8n API call. Provide a path like /workflows or a full URL.", {
      type: "object",
      properties: {
        path: { type: "string" },
    ...
    tool("n8n_list_workflows", "List n8n workflows (optional active filter).", {
      type: "object",
      properties: {
    ...
    tool("n8n_get_workflow", "Get an n8n workflow by ID.", {
      type: "object",
      properties: { id: { type: "integer" } },
      required: ["id"],
      additionalProperties: false
    }),
    tool("n8n_create_workflow", "Create an n8n workflow (requires confirmation).", {
      type: "object",
      properties: {
    ...
    tool("n8n_update_workflow", "Update an n8n workflow (requires confirmation).", {
      type: "object",
      properties: {
        id: { type: "integer" },
        workflow: { type: "object", additionalProperties: true },
    ...
    tool("n8n_delete_workflow", "Delete an n8n workflow (requires confirmation).", {
      type: "object",
      properties: {
        id: { type: "integer" },
        confirm: { type: "boolean", nullable: true }
