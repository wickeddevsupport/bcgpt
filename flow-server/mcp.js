/**
 * Flow MCP Server Implementation
 * Provides flow automation tools via Model Context Protocol
 */
...
export class FlowMCPServer {
  ...
  defineTools() {
    return [
      ...
      {
        name: 'flow_status',
        description: 'Get Flow server status and statistics',
        inputSchema: {
          type: 'object',
          properties: {},
          required: []
  ...
  async handleToolCall(toolName, args) {
    try {
      switch (toolName) {
        // Flow Management
        case 'flow_list':
          return await this.client.listFlows(args.project_id);
        
        case 'flow_get':
          return await this.client.getFlow(args.flow_id);
        ...
        case 'flow_update':
          return await this.client.updateFlow(args.flow_id, args.data);
        
        case 'flow_delete':
          return await this.client.deleteFlow(args.flow_id);
        
        // Flow Execution
        case 'flow_trigger':
          return await this.client.triggerFlow(args.flow_id, args.payload || {});
        
        case 'flow_runs_list':
          return await this.client.listFlowRuns(args.flow_id, args.limit || 10);
        
        case 'flow_run_get':
          return await this.client.getFlowRun(args.run_id);
        ...
        case 'flow_project_create':
          return await this.client.createProject(args.name);
        
        // Pieces
        case 'flow_pieces_list':
          return await this.client.listPieces();
        
        // Connections
        case 'flow_connections_list':
          return await this.client.listConnections(args.project_id);
