export const MAX_PAYLOAD_BYTES = 20 * 1024 * 1024; // 20 MB — supports file/image attachments
export const MAX_BUFFERED_BYTES = 25 * 1024 * 1024; // per-connection send buffer limit
