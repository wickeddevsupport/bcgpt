...
import { isSuperAdmin, isWorkspaceAdmin } from "../workspace-context.js";
import { ErrorCodes, errorShape } from "../protocol/index.js";

export const systemHandlers: GatewayRequestHandlers = {
  "gateway.restart": ({ respond, client }) => {
    if (!client || !isWorkspaceAdmin(client)) {
      respond(false, undefined, errorShape(ErrorCodes.INVALID_REQUEST, "workspace_admin or super_admin role required"));
      return;
    }
