...
import { ApErrorParams, ConfigureRepoRequest, ErrorCode, GitBranchType, GitRepo } from '@activepieces/shared';
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="git@github.com:wickedlab/wicked-flow.git"
                        {...field}
                      />
                    </FormControl>
                  </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="wicked-flow" {...field} />
                    </FormControl>
                    <FormDescription>
                      {t(
